...
typedef struct
{
  ...
  uint8_t Interrupt_DataReady_INT1;			/* Data-ready interrupt enabled or disable and routed to INT1 */
	uint8_t Interrupt_Vector_Filter;			/* VLIFT Vector filter */
  ...
  uint8_t State_Machine1_Interrupt;     /* State Machine 1 routed Interrupt into CTRL_REG1 register */
	uint8_t State_Machine1_Hysteresis;		/* State_ Machine 1 Hysteresis value 0 -> 7 */
  ...
  uint8_t State_Machine2_Interrupt;     /* State Machine 2 routed Interrupt into CTRL_REG1 register */
	uint8_t State_Machine2_Hysteresis;		/* State_ Machine 1 Hysteresis value 0 -> 7 */
...
*             0: disable (Default)
*             1: enable
*  5 STP_WTM: Stop on Watermark - FIFO depth can be limited at the Watermark value, by setting to S1 the STP_WTM bit. 
*             0: disable (Default)
*             1: enable
...
// Data_Rate_Power_Mode_selection                
...
// Anti-Aliasing_Filter_Bandwidth 
...
// Interrupt_Request_selection    Interrupt_Selection_Enable
...
#define LIS3DSH_INTERRUPT_1_ENABLE           ((uint8_t)0x08)
#define LIS3DSH_INTERRUPT_2_ENABLE           ((uint8_t)0x10)
#define LIS3DSH_INTERRUPT_1_2_ENABLE         ((uint8_t)0x18)
...
// Data-ready interrupt enabled and routed to INT1
#define LIS3DSH_INTERRUPT_DATA_READY_ENABLE  ((uint8_t)0x80)
#define LIS3DSH_INTERRUPT_DATA_READY_DISABLE ((uint8_t)0x00)

// State_Machine_Enable
#define LIS3DSH_SM_ENABLE                   ((uint8_t)0x01)
#define LIS3DSH_SM_DISABLE                  ((uint8_t)0x00)
  
// State_Machine_Routed_Interrupt
#define LIS3DSH_SM_INT1                     ((uint8_t)0x00)
#define LIS3DSH_SM_INT2                     ((uint8_t)0x08)

// Hysteresis which ( Default value: 0x00 )
#define LIS3DSH_SM_HYST_0										 ((uint8_t)0x00)		
#define LIS3DSH_SM_HYST_1										 ((uint8_t)0x01)	
#define LIS3DSH_SM_HYST_2										 ((uint8_t)0x02)	
#define LIS3DSH_SM_HYST_3										 ((uint8_t)0x03)	
#define LIS3DSH_SM_HYST_4										 ((uint8_t)0x04)	
#define LIS3DSH_SM_HYST_5										 ((uint8_t)0x05)	
#define LIS3DSH_SM_HYST_6										 ((uint8_t)0x06)	
#define LIS3DSH_SM_HYST_7										 ((uint8_t)0x07)

// VLIFT Vector filter
#define LIS3DSH_VLIFT_VECTOR_FILTER_ENABLE	 ((uint8_t)0x04)
#define LIS3DSH_VLIFT_VECTOR_FILTER_DISABLE	 ((uint8_t)0x00)
...
// Stat Machine flags
#define LIS3DSH_STAT_NEW_DATA_READY					 ((uint8_t)0x01)

// bitmask of MASK_A
#define LIS3DSH_MASK_A_N_V         				  ((uint8_t)0x01)
#define LIS3DSH_MASK_A_P_V         				  ((uint8_t)0x02)
#define LIS3DSH_MASK_A_N_Z         				  ((uint8_t)0x04)
#define LIS3DSH_MASK_A_P_Z         				  ((uint8_t)0x08)
#define LIS3DSH_MASK_A_N_Y         				  ((uint8_t)0x10)
#define LIS3DSH_MASK_A_P_Y         				  ((uint8_t)0x20)
#define LIS3DSH_MASK_A_N_X         				  ((uint8_t)0x40)
#define LIS3DSH_MASK_A_P_X         				  ((uint8_t)0x80)

// bitmask of MASK_B
#define LIS3DSH_MASK_B_N_V         				  ((uint8_t)0x01)
#define LIS3DSH_MASK_B_P_V         				  ((uint8_t)0x02)
#define LIS3DSH_MASK_B_N_Z         				  ((uint8_t)0x04)
#define LIS3DSH_MASK_B_P_Z         				  ((uint8_t)0x08)
#define LIS3DSH_MASK_B_N_Y         				  ((uint8_t)0x10)
#define LIS3DSH_MASK_B_P_Y         				  ((uint8_t)0x20)
#define LIS3DSH_MASK_B_N_X         				  ((uint8_t)0x40)
#define LIS3DSH_MASK_B_P_X         				  ((uint8_t)0x80)

// bitmask of SETT
#define LIS3DSH_SETT_SITR          				  ((uint8_t)0x01)
#define LIS3DSH_SETT_R_TAM         				  ((uint8_t)0x02)
#define LIS3DSH_SETT_THR3_MA       				  ((uint8_t)0x04)
#define LIS3DSH_SETT_ABS           				  ((uint8_t)0x20)
#define LIS3DSH_SETT_THR3_SA       				  ((uint8_t)0x40)
#define LIS3DSH_SETT_P_DET         				  ((uint8_t)0x80)

// bit mask for state machine operation codes 
#define LIS3DSH_NEXT                				 <<0
#define LIS3DSH_RESET               				 <<4
#define LIS3DSH_NOP                 				 ((uint8_t)0x00)
#define LIS3DSH_TI1                 				 ((uint8_t)0x01)
#define LIS3DSH_TI2                 				 ((uint8_t)0x02)
#define LIS3DSH_TI3                 				 ((uint8_t)0x03)
#define LIS3DSH_TI4                 				 ((uint8_t)0x04)
#define LIS3DSH_GNTH1               				 ((uint8_t)0x05)
#define LIS3DSH_GNTH2               				 ((uint8_t)0x06)
#define LIS3DSH_LNTH1               				 ((uint8_t)0x07)
#define LIS3DSH_LNTH2               				 ((uint8_t)0x08)
#define LIS3DSH_GTTH1               				 ((uint8_t)0x09)
#define LIS3DSH_LLTH2               				 ((uint8_t)0x0A)
#define LIS3DSH_GRTH1               				 ((uint8_t)0x0B)
#define LIS3DSH_LRTH1               				 ((uint8_t)0x0C)
#define LIS3DSH_GRTH2               				 ((uint8_t)0x0D)
#define LIS3DSH_LRTH2               				 ((uint8_t)0x0E)
#define LIS3DSH_NZERO               				 ((uint8_t)0x0F)
#define LIS3DSH_CONT                				 ((uint8_t)0x11)
#define LIS3DSH_OUTC                				 ((uint8_t)0x88)
#define LIS3DSH_SRP                				 	 ((uint8_t)0x33)


// LIS3DSH_Exported_Functions
